...
const Title = ({myText}) => {
    ...
    return (
        <div ref={containerTitle}
             className="relative w-full lg:w-screen h-screen flex flex-col overflow-hidden bg-zinc-200 opacity-30">
            <div className="relative -top-[25%] -left-[12.5%] -rotate-12 w-[125%] text-blue-400">
