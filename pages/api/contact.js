        ...
        if (data.firstName && data.lastName && data.email && data.message) {
            ...
            try {
                await transporter.sendMail({
                    ...mailOptions,
                    subject: "E-LA Portfolio - New message from " + data.firstName + " " + data.lastName,
                    ...generateEmailContent(data)
                    /*text: "This is a test string",
                    html: "" +
                        "<p>You got a new message from " + data.firstName + " " + data.lastName + " [" + data.email + "]" + ":</p>\n" +
                        "<p style=\"padding: 12px; border-left: 4px solid #d0d0d0; font-style: italic;\">" + data.message + "</p>\n" +
                        "<p>Best wishes,<br>Me</p>"*/
                })
